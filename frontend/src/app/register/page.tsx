...
export default function Register() {
  ...
  const [form, setForm] = useState<RegisterForm>({
    ...
    adresa: "",
    broj: "",
    role: "predavac", // default
    spol: "MUSKO", // enum value in uppercase
    avatar_url: null,
  });
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setSnackbarMessage("Greška: " + JSON.stringify(errorData.detail));
        ...
        <Box sx={{ width: "100%", maxWidth: 400, display: "flex", flexDirection: "column", gap: 3 }}>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <Select
              ...
              sx={{ mt: 2 }}
            >
              <MenuItem value="predavac">Predavač</MenuItem>
            ...
            <Select
              ...
              sx={{ mt: 2 }}
            >
              <MenuItem value="MUSKO">Muški</MenuItem>
              <MenuItem value="ZENSKO">Ženski</MenuItem>
            </Select>
            <Button
              type="submit"
              variant="contained"
